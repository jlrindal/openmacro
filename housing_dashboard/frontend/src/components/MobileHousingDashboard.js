...
import { LineChart, Line, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer, BarChart, Cell, Bar, ReferenceLine, Legend } from 'recharts';
  ...
  return (
    <div className="min-h-screen bg-white text-gray-800">
      ...
      <div className="p-4 md:max-w-6xl md:mx-auto md:px-8 relative">
        ...
        <div className="mt-8 w-full mx-auto max-w-6xl h-screen md:h-screen bg-white p-8 rounded-lg border border-gray-100 shadow-sm">
          <ResponsiveContainer width="100%" height="100%">
            <LineChart
              data={filteredData}
